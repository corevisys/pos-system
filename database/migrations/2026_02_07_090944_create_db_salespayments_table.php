...
return new class extends Migration
{
    ...
    {
        Schema::create('db_salespayments', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('advance_adjusted', 16, 2)->default(0);
            $table->string('cheque_number')->nullable();
            $table->date('cheque_period')->nullable();
    ...
    {
        Schema::dropIfExists('db_salespayments');
    }
};
