...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             */
            // Use integer values to avoid requiring the ZipArchive extension during console commands
            // (e.g. migrations) when the extension is not enabled.
             ...
             */
            'filename_prefix' => 'laravel-pos-backup-',
