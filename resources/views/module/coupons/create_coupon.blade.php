<x-app-layout title="Create Coupon">
    <div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
            <div>
                <h1 class="text-xl font-black tracking-tight text-text-primary dark:text-dark-text">Discount Coupon</h1>
                <div class="flex items-center gap-2 text-text-muted font-medium mt-1">
                    ...
                    <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                    <span class="text-text-secondary text-[10px] font-bold uppercase tracking-widest">New Coupon</span>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-3xl mx-auto" x-data="{
            ...
            <div class="card p-6">
                <div class="flex items-center gap-3 mb-6 border-b border-border-light dark:border-dark-border pb-4">
                    ...
                    <div>
                        <h2 class="text-sm font-black text-text-primary dark:text-dark-text uppercase tracking-wider">Master Coupon Configuration</h2>
                        <p class="text-[10px] text-text-muted font-bold uppercase tracking-widest mt-0.5">Define master promotional parameters for store campaigns</p>
                    </div>
                </div>
                ...
                <form action="{{ route('coupons.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-y-4">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center gap-2 md:gap-6">
                            ...
                            <div class="flex-1">
                                <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g., Summer Sale, Eid Special" class="input-base" required>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row md:items-center gap-2 md:gap-6">
                            ...
                            <div class="flex-1 relative">
                                <input type="date" name="expire_date" value="{{ old('expire_date') }}" class="input-base" required>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row items-start gap-2 md:gap-6">
                            ...
                            <div class="flex-1">
                                <textarea name="description" rows="3" placeholder="Campaign details or terms..." class="input-base">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
