<x-app-layout title="Add Money Transfer">
    <div>
        <!-- HEADER & BREADCRUMBS -->
            ...
            <div>
                <h1 class="text-xl font-black tracking-tight flex items-center gap-2 text-text-primary dark:text-dark-text">
                    <div class="w-8 h-8 rounded-xl bg-primary/10 flex items-center justify-center">
                        <svg class="w-5 h-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path></svg>
                    </div>
                    New Money Transfer
                </h1>
                <div class="flex items-center gap-2 text-text-muted font-medium mt-1">
                    ...
                    <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                    <span class="text-text-secondary text-[10px] font-bold uppercase tracking-widest">New Transfer</span>
                </div>
            </div>
        ...
        <form action="{{ route('accounts.transfer.store') }}" method="POST" class="max-w-4xl mx-auto" x-data="{ isSubmitting: false }" @submit="if(isSubmitting) { $event.preventDefault(); return false; } isSubmitting = true;">
            @csrf
            <x-card class="overflow-hidden p-0">
                <div class="px-8 py-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                        ...
                        <div class="group relative">
                            ...
                            <div class="relative">
                                ...
                                <input type="date" name="transfer_date" value="{{ date('Y-m-d') }}" required class="input-base !pl-12 !py-3.5 !text-[11px] !font-bold">
                            </div>
                        </div>
                        ...
                        <div class="group relative">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="transfer_code" value="{{ $transferCode }}" readonly required class="input-base !pl-12 !py-3.5 !text-[11px] !font-black !text-primary !tracking-wider !font-mono !bg-background dark:!bg-slate-900">
                            </div>
                        </div>
                        ...
                        <div class="group relative">
                            ...
                            <div class="relative">
                                ...
                                <div class="pl-4">
                                    <x-searchable-select name="debit_account_id" :options="$accounts" labelKey="account_name" valueKey="id" emptyOption="Select Source Account" emptyValue="" placeholder="Select Source Account" :value="old('debit_account_id')" required />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="group relative md:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="amount" placeholder="0.00" required class="input-base !pl-14 !py-5 !text-2xl !font-black tabular-nums">
                        ...
                        <div class="group relative">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="reference_no" placeholder="Optional reference" class="input-base !pl-12 !py-3.5 !text-[11px] !font-bold">
                            </div>
                        </div>
                        ...
                        <div class="group relative">
                            ...
                            <div class="relative">
                                ...
                                <textarea name="note" rows="1" placeholder="Add a note..." class="input-base !pl-12 !py-3.5 !text-[11px] !font-bold resize-none"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="mt-10 flex flex-col md:flex-row gap-4">
                        <button type="submit" :disabled="isSubmitting" class="btn-primary flex-1 !py-4 !text-[11px] uppercase tracking-widest disabled:opacity-50 disabled:pointer-events-none">
                        ...
                        <button type="reset" class="btn-secondary px-10 !py-4 !text-[11px] uppercase tracking-widest">Reset</button>
                    </div>
                </div>
            </x-card>
        </form>
