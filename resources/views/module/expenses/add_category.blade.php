<x-app-layout title="Add Expense Category">
    <div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
            <div>
                <h1 class="text-xl font-black tracking-tight">Add Expense Category</h1>
                <div class="flex items-center gap-2 text-slate-400 font-medium mt-1">
                    ...
                    <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                    <span class="text-slate-600 text-[10px] font-bold">New Category</span>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white dark:bg-dark-card p-4 md:p-6 rounded-3xl border border-slate-100 dark:border-dark-border shadow-sm">
                ...
                <div class="flex items-center gap-3 mb-6 border-b border-slate-50 dark:border-dark-border pb-4">
                    <div class="p-2 bg-emerald-50 dark:bg-emerald-500/10 rounded-xl">
                         <svg class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
                    </div>
                    <div>
                        <h2 class="text-sm font-black text-slate-800 dark:text-white uppercase tracking-wider">New Category</h2>
                        <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest mt-0.5">Create a new expense category</p>
                    </div>
                </div>

                <form action="{{ route('expenses.categories.store') }}" method="POST" class="space-y-4">
                    @csrf
                    <!-- Form Fields Grid -->
                    <div class="grid grid-cols-1 gap-y-4">
                        ...
                        <div class="flex flex-col md:flex-row md:items-center gap-3 md:gap-6">
                            ...
                            <div class="flex-1">
                                <input type="text" name="category_name" placeholder="e.g. Office Supplies" class="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-xl py-2 px-4 text-[10px] font-bold transition-all focus:ring-1 focus:ring-primary-500">
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row md:items-center gap-3 md:gap-6">
                            ...
                            <div class="flex-1">
                                <input type="text" name="category_code" placeholder="Optional" class="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-xl py-2 px-4 text-[10px] font-bold transition-all focus:ring-1 focus:ring-primary-500">
                            </div>
                        </div>
                        ...
                        <div class="flex flex-col md:flex-row items-start gap-3 md:gap-6">
                            ...
                            <div class="flex-1">
                                <textarea name="description" rows="3" placeholder="Category details..." class="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-xl py-2 px-4 text-[10px] font-bold transition-all focus:ring-1 focus:ring-primary-500"></textarea>
                            </div>
                        </div>
