<x-app-layout title="Add Messaging Template">
    <div>
        <form action="{{ route('messaging.templates.store') }}" method="POST">
            @csrf
            
            <!-- HEADER & ACTIONS -->
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
                <div>
                    <h1 class="text-xl font-black tracking-tight text-slate-800 dark:text-white">Message Template <span class="text-[10px] font-bold text-slate-400 ml-2 italic uppercase tracking-widest font-black">Add New Template</span></h1>
                    <div class="flex items-center gap-2 text-slate-400 font-medium mt-1">
                        ...
                        <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                        <span class="text-slate-600 text-[10px] font-black uppercase tracking-wider">Add Template</span>
                    </div>
                </div>
                ...
                <div class="flex gap-2 w-full md:w-auto">
                    ...
                    <button type="submit" class="flex-1 md:flex-none px-6 py-2 bg-emerald-500 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-emerald-600 transition-all shadow-lg shadow-emerald-200/50 dark:shadow-none flex items-center justify-center gap-2">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-4">
                    <div class="bg-white dark:bg-dark-card p-6 rounded-3xl border border-slate-100 dark:border-dark-border shadow-sm">
                        <div class="flex items-center gap-2 mb-6 px-1">
                            ...
                            <h2 class="text-[11px] font-black uppercase tracking-[0.2em] text-primary-600">Template Details</h2>
                        </div>
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="template_name" value="{{ old('template_name') }}" required placeholder="e.g. GREETING TO CUSTOMER ON SALES" class="w-full bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-dark-border rounded-2xl py-3 px-4 text-[11px] font-bold transition-all focus:ring-1 focus:ring-primary-500 text-slate-700 dark:text-white outline-none">
                            </div>
                ...
                <div class="space-y-4">
                    <div class="bg-slate-900 dark:bg-dark-card p-6 rounded-3xl shadow-2xl relative overflow-hidden group">
                        ...
                        <div class="absolute -top-24 -right-24 w-48 h-48 bg-primary-500/20 rounded-full blur-[80px] group-hover:bg-primary-500/30 transition-all duration-700"></div>
                        
                        <div class="relative z-10">
                            <div class="flex items-center gap-2 mb-6">
                                <div class="w-8 h-8 bg-primary-500/20 rounded-xl flex items-center justify-center">
                                    <svg class="w-4 h-4 text-primary-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                </div>
                            ...
                            <p class="text-[10px] font-medium text-slate-400 mb-6 leading-relaxed">
                                Copy and paste these variables into your template content to dynamically pull data.
                            </p>
                    ...
                    <!-- TIPS SECTION -->
                    <div class="bg-emerald-500/5 border border-emerald-500/10 p-5 rounded-3xl">
                        <div class="flex items-center gap-2 mb-3">
                            <div class="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse"></div>
                            <h4 class="text-[9px] font-black uppercase tracking-widest text-emerald-600">Pro Tip</h4>
                        </div>
                        <p class="text-[10px] font-medium text-emerald-800/60 leading-relaxed italic">
                            Keep your SMS content under 160 characters for a single message. Long messages may incur additional costs depending on your provider.
                        </p>
                    </div>
                </div>
            </div>
