<x-app-layout title="Add Service">
    <div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
            <div>
                <h1 class="text-xl font-black tracking-tight text-text-primary dark:text-dark-text">Services <span class="text-[10px] font-bold text-text-muted ml-2 italic uppercase tracking-widest">Add Service</span></h1>
                <div class="flex items-center gap-2 text-text-muted font-medium mt-1">
                    ...
                    <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                    <span class="text-text-secondary text-[10px] font-bold uppercase tracking-wider">Add Service</span>
                </div>
        ...
        <!-- MAIN FORM -->
        <div class="card p-4 md:p-6" x-data="addServiceForm()">
            <form id="serviceForm"
                  action="{{ route('items.service.store') }}"
                  method="POST"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <input type="text" name="item_name" value="{{ old('item_name') }}"
                                   ...
                                   placeholder="E.g. Consultation Fee" class="input-base">
                            @error('item_name')
                        ...
                        <div>
                            ...
                            <input type="text" name="item_code" value="{{ old('item_code', $itemCode) }}" class="input-base font-mono tracking-wider">
                            @error('item_code')
                                <p class="text-[9px] font-bold text-danger mt-1 ml-0.5">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="hsn" value="{{ old('hsn') }}" class="input-base">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="description" value="{{ old('description') }}" placeholder="Service details..." class="input-base">
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="discount" value="{{ old('discount', 0) }}" placeholder="0.00" class="input-base pr-8 tabular-nums">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="price" value="{{ old('price') }}" placeholder="Price w/o Tax" class="input-base pl-7 tabular-nums">
                            </div>
                            @error('price')
                                <p class="text-[9px] font-bold text-danger mt-1 ml-0.5">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="sales_price" value="{{ old('sales_price') }}" placeholder="Sales Price" class="input-base pl-7 tabular-nums !border-primary/30 !bg-primary/5">
                            </div>
                            @error('sales_price')
                                <p class="text-[9px] font-bold text-danger mt-1 ml-0.5">{{ $message }}</p>
                            @enderror
    ...
    @php
        ...
        $oldTaxType = old('tax_type', 'Inclusive');
    @endphp
    @push('scripts')
    <script>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('addServiceForm', addServiceForm);
        });
    </script>
    @endpush
</x-app-layout>
