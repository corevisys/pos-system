<x-app-layout title="Edit Brand">
    <div x-data="{ isSubmitting: false }">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
            <div>
                <h1 class="text-xl font-black tracking-tight text-text-primary dark:text-dark-text">Brands <span class="text-[10px] font-bold text-text-muted ml-2 italic uppercase tracking-widest">Edit Brand</span></h1>
                <div class="flex items-center gap-2 text-text-muted font-medium mt-1">
                    ...
                    <svg class="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"></path></svg>
                    <span class="text-text-secondary text-[10px] font-bold uppercase tracking-wider">Edit Brand</span>
                </div>
        ...
        <div class="card p-4 md:p-6">
            <form id="brandForm" action="{{ route('items.brands.update', $brand->id) }}" method="POST" class="space-y-8"
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="brand_code" value="{{ old('brand_code', $brand->brand_code) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="4" placeholder="Briefly describe this brand..." class="input-base resize-y">{{ old('description', $brand->description) }}</textarea>
                            @error('description')
                                <p class="text-[9px] font-bold text-danger mt-1 ml-0.5">{{ $message }}</p>
                            @enderror
                        </div>
