        ...
        <div class="space-y-4">
                ...
                <form action="#" method="POST" enctype="multipart/form-data">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                        ...
                        <div class="group relative md:col-span-1">
                            ...
                            <div class="relative">
                                <select name="warehouse" class="w-full bg-slate-50 dark:bg-slate-800 border-none rounded-xl py-2 px-3 text-[10px] font-bold text-slate-700 dark:text-slate-300 outline-none focus:ring-1 focus:ring-primary-500 transition-all appearance-none leading-tight">
            ...
            <div class="bg-white dark:bg-dark-card rounded-3xl border border-slate-100 dark:border-dark-border shadow-sm overflow-hidden" x-data="{
                instructions: [
                    ...
                    { name: 'SKU', status: 'Optional', desc: '' },
                    { name: 'HSN', status: 'Optional', desc: '' },
                    { name: 'Unit Name', status: 'Required', desc: '' },
                    { name: 'Alert Quantity', status: 'Optional', desc: '' },
                    { name: 'Brand Name', status: 'Optional', desc: '' },
                    ...
                    { name: 'Tax Type', status: 'Required', desc: '“Inclusive” or “exclusive”' },
                    { name: 'Sales Price', status: 'Required', desc: '' },
                    { name: 'Opening Stock', status: 'Required', desc: '' },
