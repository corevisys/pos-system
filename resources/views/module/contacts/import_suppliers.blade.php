<x-app-layout title="Import Suppliers">
    <div class="space-y-6">

        <!-- HEADER & BREADCRUMBS -->
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h1 class="text-xl font-bold tracking-tight text-text-primary dark:text-dark-text">Import Suppliers</h1>
                <nav class="flex items-center gap-2 text-xs text-text-muted mt-1" aria-label="Breadcrumb">
                    ...
                    <a href="{{ route('contacts.suppliers.list') }}" class="hover:text-primary transition-colors font-medium">Suppliers List</a>
                    <svg class="w-3 h-3 text-text-muted/60" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                <a href="{{ route('contacts.suppliers.import.template') }}" class="btn-secondary w-full md:w-auto text-xs py-2">
            ...
            <div class="lg:col-span-1">
                <x-card class="h-full flex flex-col justify-between">
                    <div>
                        <div class="flex items-center gap-2.5 mb-4">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-text-muted">Select or drop a valid supplier CSV</p>
                            </div>
                        </div>

                        <form action="{{ route('contacts.suppliers.import.store') }}" 
                              method="POST" 
                            ...
                            <div class="flex items-center gap-2 pt-2">
                                <button type="submit" 
                                    ...
                                    <span x-text="isSubmitting ? 'Importing...' : 'Import Suppliers'"></span>
                                </button>
                    ...
                    <div class="mt-6 pt-4 border-t border-border dark:border-dark-border text-xs text-text-muted space-y-1.5">
                        ...
                        <p>• Mobile and email must be unique across all suppliers.</p>
                        <p>• Supplier codes will be automatically generated.</p>
                        <p>• Opening balance will be added to the supplier account.</p>
                    </div>
                </x-card>
            </div>
            ...
            <div class="lg:col-span-2">
                <x-card padding="p-0" class="overflow-hidden">
                    <div class="p-4 border-b border-border dark:border-dark-border flex items-center justify-between">
                        ...
                        <span class="text-xs text-text-muted">11 Columns</span>
                    </div>

                    <div class="overflow-x-auto custom-scrollbar">
                        <table class="w-full text-left border-collapse text-xs" x-data="{
                            instructions: [
                                { id: 1, column: 'Supplier Name', value: 'Required', details: 'Full business or company name of the supplier' },
                                { id: 2, column: 'Mobile', value: 'Optional', details: 'Unique contact mobile number' },
                                { id: 3, column: 'Email', value: 'Optional', details: 'Unique company or contact email' },
                                { id: 4, column: 'Phone', value: 'Optional', details: 'Alternative office / telephone number' },
                                { id: 5, column: 'GST Number', value: 'Optional', details: 'GSTIN tax identification number' },
                                { id: 6, column: 'TAX Number', value: 'Optional', details: 'Income tax or VAT identification number' },
                                { id: 7, column: 'Country Name', value: 'Optional', details: 'Supplier country (e.g. Bangladesh)' },
                                { id: 8, column: 'State Name', value: 'Optional', details: 'Supplier state / district (e.g. Dhaka)' },
                                { id: 9, column: 'Postcode', value: 'Optional', details: 'Postal code / ZIP code' },
                                { id: 10, column: 'Address', value: 'Optional', details: 'Physical office / warehouse address' },
                                { id: 11, column: 'Opening Balance', value: 'Optional', details: 'Opening payable balance (default: 0.00)' }
                            ]
                        }">
