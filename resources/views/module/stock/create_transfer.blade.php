<x-app-layout title="Create Stock Transfer">
    <div x-data="transferForm()">
        ...
        <div class="flex flex-wrap items-center justify-between gap-3 mb-3 px-1 text-black">
            <div>
                <h1 class="text-lg font-black tracking-tight text-slate-800 dark:text-white">Create Stock Transfer</h1>
                <p class="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">Move inventory between warehouses with full traceability</p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-3">
                    ...
                    <div class="relative group" @click.away="searchResults = []">
                        ...
                        <div x-show="searchResults.length > 0" 
                            ...
                            <template x-for="item in searchResults" :key="item.id">
                                <div @click="addItem(item)" class="px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-800 cursor-pointer transition-colors border-b border-slate-50 dark:border-dark-border last:border-none flex items-center justify-between gap-3">
                ...
                <div class="bg-white dark:bg-dark-card rounded-2xl border border-slate-100 dark:border-dark-border overflow-hidden flex-1 shadow-sm">
                    <div class="overflow-x-auto custom-scrollbar min-h-[400px]">
                        <table class="w-full text-left">
                            <thead class="bg-slate-50 dark:bg-slate-800/50 sticky top-0 z-10 shadow-sm border-b border-slate-100 dark:border-dark-border">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-[9px] font-black text-slate-400 uppercase tracking-widest text-center whitespace-nowrap">Source Stock</th>
                                    <th class="px-4 py-3 text-[9px] font-black text-slate-400 uppercase tracking-widest text-center whitespace-nowrap">Transfer Qty</th>
                                    ...
                                    <tr class="hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors group">
                                        <td class="px-4 py-2">
                                            <div class="flex flex-col">
                                                ...
                                                <div class="flex items-center gap-2 mt-0.5 text-black">
                        ...
                        <div x-show="form.items.length === 0" class="flex flex-col items-center justify-center py-20 px-6 text-center">
                            ...
                            <p class="text-[10px] text-slate-400 mt-1 font-medium">Search items in the selected source warehouse</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-4 flex flex-col gap-3">
                ...
                <div class="bg-white dark:bg-dark-card p-4 rounded-2xl shadow-sm border border-slate-100 dark:border-dark-border flex flex-col gap-4">
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <input type="text" x-model="form.reference_no" placeholder="Auto-generated (e.g. TR-2023...)" 
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        ...
                        <div>
                            <label class="text-[9px] font-black uppercase text-slate-400 tracking-widest block mb-1 pl-1">Transfer Note</label>
                            <textarea x-model="form.note" rows="2" placeholder="Reference, vehicle no, etc..." 
                ...
                <div class="bg-slate-900 rounded-[2rem] p-6 shadow-2xl text-white relative overflow-hidden group">
                    ...
                    <div class="relative space-y-4">
                        <div class="flex justify-between items-center border-b border-white/10 pb-3">
                            <h3 class="text-[9px] font-black uppercase tracking-widest text-slate-400">Transfer Summary</h3>
                        ...
                        <div class="space-y-1 text-center py-2">
                            <p class="text-[9px] font-black uppercase tracking-[0.2em] text-primary-400">Total Transfer Quantity</p>
                ...
                <p class="text-[9px] text-center font-bold text-slate-400 uppercase tracking-widest px-8 uppercase italic">
                    Caution: Stock will be deducted from source and added to destination immediately.
                </p>
            </div>
        </div>
        ...
        <div x-show="serialModalOpen" 
            ...
            <div class="bg-white dark:bg-dark-card w-full max-w-lg rounded-[2.5rem] shadow-2xl p-8 transform transition-all border border-slate-100 dark:border-dark-border"
                ...
                <div class="flex items-center justify-between mb-6 text-black">
                    <div>
                        <h2 class="text-2xl font-black text-slate-800 dark:text-white">Transferred Serials</h2>
                        <p class="text-[10px] text-slate-400 font-black uppercase tracking-widest mt-1">Select serials for: <span class="text-primary-500" x-text="currentSerialItem ? currentSerialItem.item_name : ''"></span></p>
                    </div>
                ...
                <div class="mt-8 grid grid-cols-2 gap-4">
                    ...
                    <button @click="saveSerials" class="py-4 bg-primary-500 hover:bg-primary-600 text-white rounded-2xl text-[11px] font-black uppercase tracking-widest transition-all shadow-lg shadow-primary-500/40">Confirm Serials</button>
                </div>
            </div>
        </div>
             ...
             Alpine.data('transferForm', () => ({
                ...
                async submitForm() {
                    ...
                    try {
                        ...
                        if (result.success) {
                            // Toast will appear on the transfer list page via session flash
                            // but show a brief one here too before redirect
