<x-app-layout title="Purchase Return Report">
    <div x-data="purchaseReturnReportJS()" x-cloak>
                
        <!-- HEADER & ACTIONS -->
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-6">
            <div>
                 <h1 class="text-xl font-black tracking-tight text-slate-800 dark:text-white">Purchase Return Report <span class="text-[10px] font-bold text-slate-400 ml-2 italic uppercase tracking-widest">Returns & Refunds</span></h1>
                <div class="flex items-center gap-2 text-slate-400 font-medium mt-1">
                    ...
                    <span class="text-slate-600 text-[10px] font-black uppercase tracking-wider">Purchase Return Report</span>
                </div>
            </div>
        </div>
    ...
    <script>
        function purchaseReturnReportJS() {
            return {
                warehouseId: 'all',
                supplierId: 'all',
                ...
                get filteredRecords() {
                    ...
                    return this.records.filter(r => 
                        ...
                        (r.purchaseCode && r.purchaseCode.toLowerCase().includes(this.searchTerm.toLowerCase()))
                    );
                },
                ...
                fetchData() {
                    this.isLoading = true;
                    let url = `{{ route('reports.purchase_return_data') }}?start_date=${this.fromDate}&end_date=${this.toDate}&warehouse_id=${this.warehouseId}&supplier_id=${this.supplierId}`;
