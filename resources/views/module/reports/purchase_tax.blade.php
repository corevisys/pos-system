<x-app-layout title="Purchase Tax Report">
    <div x-data="purchaseTaxReport()" x-cloak>
                
        <!-- HEADER & ACTIONS -->
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-6">
            <div>
                 <h1 class="text-xl font-black tracking-tight text-slate-800 dark:text-white">Purchase Tax Report <span class="text-[10px] font-bold text-slate-400 ml-2 italic uppercase tracking-widest">Tax Paid</span></h1>
                <div class="flex items-center gap-2 text-slate-400 font-medium mt-1">
                    ...
                    <span class="text-slate-600 text-[10px] font-black uppercase tracking-wider">Purchase Tax Report</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-dark-card rounded-3xl border border-slate-100 dark:border-dark-border overflow-hidden shadow-sm">
            ...
            <div class="px-4 py-3 border-b border-slate-50 dark:border-dark-border bg-slate-50/20 dark:bg-white/5 flex flex-wrap justify-between items-center gap-4">
                ...
                <div class="flex items-center gap-2">
                    <x-report-export-buttons :route="route('reports.purchase_tax_data')" />
                    <div class="relative group">
                        ...
                        <tr x-show="filteredRecords.length === 0">
                            <td colspan="5" class="px-6 py-12 text-center text-slate-400">
                                <div class="flex flex-col items-center gap-2">
                                    ...
                                    <span class="text-[10px] font-black uppercase tracking-widest opacity-50 italic">No Tax Records Found</span>
                                </div>
                            </td>
                        </tr>
        ...
        function purchaseTaxReport() {
            return {
                ...
                fetchData() {
                    ...
                    fetch(`{{ route('reports.purchase_tax_data') }}?start_date=${this.fromDate}&end_date=${this.toDate}`)
                        .then(res => res.json())
                        .then(data => {
