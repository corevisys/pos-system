<x-app-layout title="Multi-Store Dashboard">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-6">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ route('settings.store') }}" class="btn-primary text-sm flex items-center gap-1.5">
            ...
            @endif
            <a href="{{ route('dashboard') }}" class="btn-secondary text-sm flex items-center gap-1.5">
                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        @foreach($storeStats as $idx => $entry)
            ...
            <x-card padding="p-0" :hover="true" class="overflow-hidden">
