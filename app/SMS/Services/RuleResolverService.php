...
class RuleResolverService
{
     ...
     */
    public static function resolve(string $eventType)
    {
        return Cache::remember("sms_rules_{$eventType}", 3600, function () use ($eventType) {
     ...
     */
    public static function clearCache(string $eventType = null)
    {
        if ($eventType) {
